import TemplateRepresentation from '../../models/template_representation';
...
interface ServerEvents {
    ...
    "templates:load": (templates: Array<TemplateData>, templatesRepresentation: Array<TemplateRepresentation>) => void;
    "user:connected": (user: UserData) => void;
    "user:gone": (user: UserData) => void;
    "graph:updated": (graph: GraphData) => void;
    "graph:deleted": () => void;
    "template:created": (template: TemplateData, templateRepresentaion: TemplateRepresentation) => void;
